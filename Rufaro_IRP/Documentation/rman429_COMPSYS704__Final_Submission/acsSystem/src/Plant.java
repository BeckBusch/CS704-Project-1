...
public class Plant extends ClockDomain{
  ...
  public void thread2080(int [] tdone, int [] ends){
        switch(S1063){
      case 0 : 
        active[7]=0;
        ends[7]=0;
      ...
      case 1 : 
        ...
        int biggest2087 = 0;
        if(ends[8]>=biggest2087){
          biggest2087=ends[8];
        }
        if(ends[9]>=biggest2087){
          biggest2087=ends[9];
        }
        if(ends[10]>=biggest2087){
          biggest2087=ends[10];
        }
        if(ends[11]>=biggest2087){
          biggest2087=ends[11];
        }
        if(ends[12]>=biggest2087){
          biggest2087=ends[12];
        }
        if(ends[13]>=biggest2087){
          biggest2087=ends[13];
        }
        if(biggest2087 == 1){
          active[7]=1;
  ...
  public void thread2066(int [] tdone, int [] ends){
    ...
    int biggest2073 = 0;
    if(ends[8]>=biggest2073){
      biggest2073=ends[8];
    }
    if(ends[9]>=biggest2073){
      biggest2073=ends[9];
    }
    if(ends[10]>=biggest2073){
      biggest2073=ends[10];
    }
    if(ends[11]>=biggest2073){
      biggest2073=ends[11];
    }
    if(ends[12]>=biggest2073){
      biggest2073=ends[12];
    }
    if(ends[13]>=biggest2073){
      biggest2073=ends[13];
    }
    if(biggest2073 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S2059){
        ...
        case 1 : 
          ...
          int biggest2074 = 0;
          if(ends[2]>=biggest2074){
            biggest2074=ends[2];
          }
          if(ends[3]>=biggest2074){
            biggest2074=ends[3];
          }
          if(ends[4]>=biggest2074){
            biggest2074=ends[4];
          }
          if(ends[5]>=biggest2074){
            biggest2074=ends[5];
          }
          if(ends[6]>=biggest2074){
            biggest2074=ends[6];
          }
          if(ends[7]>=biggest2074){
            biggest2074=ends[7];
          }
          if(biggest2074 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          thread2080(tdone,ends);
          int biggest2088 = 0;
          if(ends[2]>=biggest2088){
            biggest2088=ends[2];
          }
          if(ends[3]>=biggest2088){
            biggest2088=ends[3];
          }
          if(ends[4]>=biggest2088){
            biggest2088=ends[4];
          }
          if(ends[5]>=biggest2088){
            biggest2088=ends[5];
          }
          if(ends[6]>=biggest2088){
            biggest2088=ends[6];
          }
          if(ends[7]>=biggest2088){
            biggest2088=ends[7];
          }
          if(biggest2088 == 1){
            active[1]=1;
