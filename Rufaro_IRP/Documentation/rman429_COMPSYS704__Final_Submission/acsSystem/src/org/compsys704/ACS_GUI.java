...
public class ACS_GUI{
    ...
    public void guiGenerator(){ 
        ...
        //Map Image
        JLabel map = new JLabel(new ImageIcon(getClass().getResource("res/map.png"))); //JLabel(new ImageIcon(getClass().getResource("images/" + name))) || JLabel( new ImageIcon("map.png"))
        ...
        avatar.setIcon(new ImageIcon(getClass().getResource("res/avatar.png")));
