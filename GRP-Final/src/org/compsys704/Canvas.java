...
public class Canvas extends JPanel {
	...
	public Canvas(){
		...
		try {
			plan = ImageIO.read(new File("src/images/plan.png"));
			fire = ImageIO.read(new File("src/images/fire.jpg"));
			ac = ImageIO.read(new File("src/images/ac.jpg"));
			fan = ImageIO.read(new File("src/images/fan.jpg"));
			heat = ImageIO.read(new File("src/images/heat.jpg"));
