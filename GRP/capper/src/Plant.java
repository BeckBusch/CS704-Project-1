...
public class Plant extends ClockDomain{
  ...
  public void thread2675(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest2682 = 0;
        if(ends[8]>=biggest2682){
          biggest2682=ends[8];
        }
        if(ends[9]>=biggest2682){
          biggest2682=ends[9];
        }
        if(ends[10]>=biggest2682){
          biggest2682=ends[10];
        }
        if(ends[11]>=biggest2682){
          biggest2682=ends[11];
        }
        if(ends[12]>=biggest2682){
          biggest2682=ends[12];
        }
        if(ends[13]>=biggest2682){
          biggest2682=ends[13];
        }
        if(biggest2682 == 1){
          active[7]=1;
  ...
  public void thread2661(int [] tdone, int [] ends){
    ...
    int biggest2668 = 0;
    if(ends[8]>=biggest2668){
      biggest2668=ends[8];
    }
    if(ends[9]>=biggest2668){
      biggest2668=ends[9];
    }
    if(ends[10]>=biggest2668){
      biggest2668=ends[10];
    }
    if(ends[11]>=biggest2668){
      biggest2668=ends[11];
    }
    if(ends[12]>=biggest2668){
      biggest2668=ends[12];
    }
    if(ends[13]>=biggest2668){
      biggest2668=ends[13];
    }
    if(biggest2668 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S2654){
        ...
        case 2 : 
          ...
          if(ends[5]>=biggest2683){
            biggest2683=ends[5];
          }
          if(ends[6]>=biggest2683){
            biggest2683=ends[6];
          }
          if(ends[7]>=biggest2683){
            biggest2683=ends[7];
          }
          if(biggest2683 == 1){
            active[1]=1;
